...
/**
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$this->setState('filter.pick_up_time.from', $app->getUserStateFromRequest($this->context.'.filter.pick_up_time.from', 'filter_from_pick_up_time', '', 'string'));
		$this->setState('filter.pick_up_time.to', $app->getUserStateFromRequest($this->context.'.filter.pick_up_time.to', 'filter_to_pick_up_time', '', 'string'));
	...
	protected function getListQuery()
	{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.customer_name LIKE ' . $search . '  OR  a.customer_phone LIKE ' . $search . '  OR  a.flight_number LIKE ' . $search . '  OR  a.pick_up_location LIKE ' . $search . '  OR  a.drop_location LIKE ' . $search . ' )');
			}
		}
		...
		// Filtering pick_up_time
		$filter_pick_up_time_from = $this->state->get("filter.pick_up_time.from");
		...
		$filter_pick_up_time_to = $this->state->get("filter.pick_up_time.to");
